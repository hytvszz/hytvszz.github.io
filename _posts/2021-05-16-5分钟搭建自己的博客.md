...
我的Blog项目是基于github pages，基本fork了lemonchann的项目，做了一点页面的改动和个性化了自己的信息。具体如下：
 ...
 - 增加post的倒序 (by reserved keyword) 和Tag的按字母排序 (中文待修复？)
 - 待修复： 支持隐藏post （by if sentence and header parameter，项目更改一般人不可见）
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbODI5NzQzOTMzLDkzMzEwNDI3MCwtMTYxMz
Q4NjcwNCwtMTQwNzMzMDU5MywxOTI1MzEwMzI0LC00MzI2MTQx
Miw5ODM0OTA4OTIsMTEyMjAzMjAzNCwxNTc5NDI4MzUyLC02Nz
QzMDU2NTIsNTMzMjE1MjY2LDg0MjIyNjk2OF19
-->