...
然后绿线是收入分配绝对平等线（）之间的面积为A，实际收入分配曲线（红线）和收入分配绝对不平等线（蓝线）之间的面积为B，则表示收入与人口之间的比例的基尼系数为{\displaystyle {\tfrac {A}{A+B}}}\tfrac{A}{A + B}[4]。
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTkyMjgyMzE2Miw4NTc1NzQ3NDddfQ==
-->