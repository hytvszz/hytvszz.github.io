...
2. 利用chrome插件。可能有好几款，我用的叫Keep Awake (Display | System)，安装之后，它有两个模式只要chrome不关闭
...
5. Reboot laptop
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEwODM4Mzc2MTksLTE4OTIzNTYxMzEsLT
E3NTYwMDQ0OTYsLTE4OTc5NTI3NDcsLTU1NTIzNTg5NF19
-->