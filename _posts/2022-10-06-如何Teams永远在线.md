...
1. **物理按压法**。这个最简单直接，也不需要任何前置工作，适合在任何方法临时失效，或者陌生的设备上不需要set up的使用。使用方法：打开记事本，电脑放平，找一个大小合适，重量足够的东西，压住一个按键（推荐空格键，位置方便而且），

<!--stackedit_data:
eyJoaXN0b3J5IjpbLTQxMjUwMTcyNiwyODQxMTI2MzIsLTE4OT
