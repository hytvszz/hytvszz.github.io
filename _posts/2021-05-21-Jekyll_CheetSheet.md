...
## [](https://gist.github.com/JJediny/a466eed62cee30ad45e2#output)Output
...
### [](https://gist.github.com/JJediny/a466eed62cee30ad45e2#advanced-output-filters)Advanced output: Filters
...
### [](https://gist.github.com/JJediny/a466eed62cee30ad45e2#standard-filters)Standard Filters
...
-   `replace`  - replace each occurrence  _e.g._  `{{ 'foofoo' | replace:'foo','bar' }} #=> 'barbar'`
-   `replace_first`  - replace the first occurrence  _e.g._  `{{ 'barbar' | replace_first:'bar','foo' }} #=> 'foobar'`
-   `remove`  - remove each occurrence  _e.g._  `{{ 'foobarfoobar' | remove:'foo' }} #=> 'barbar'`
-   `remove_first`  - remove the first occurrence  _e.g._  `{{ 'barbar' | remove_first:'bar' }} #=> 'bar'`
-   `truncate`  - truncate a string down to x characters. It also accepts a second parameter that will append to the string  _e.g._  `{{ 'foobarfoobar' | truncate: 5, '.' }} #=> 'foob.'`
-   `truncatewords`  - truncate a string down to x words
-   `prepend`  - prepend a string  _e.g._  `{{ 'bar' | prepend:'foo' }} #=> 'foobar'`
-   `append`  - append a string  _e.g._  `{{ 'foo' | append:'bar' }} #=> 'foobar'`
-   `slice`  - slice a string. Takes an offset and length,  _e.g._  `{{ "hello" | slice: -3, 3 }} #=> llo`
-   `minus`  - subtraction  _e.g._  `{{ 4 | minus:2 }} #=> 2`
-   `plus`  - addition  _e.g._  `{{ '1' | plus:'1' }} #=> 2`,  `{{ 1 | plus:1 }} #=> 2`
-   `times`  - multiplication  _e.g_  `{{ 5 | times:4 }} #=> 20`
-   `divided_by`  - integer division  _e.g._  `{{ 10 | divided_by:3 }} #=> 3`
-   `round`  - rounds input to the nearest integer or specified number of decimals
-   `split`  - split a string on a matching pattern  _e.g._  `{{ "a~b" | split:"~" }} #=> ['a','b']`
-   `modulo`  - remainder,  _e.g._  `{{ 3 | modulo:2 }} #=> 1`

## [](https://gist.github.com/JJediny/a466eed62cee30ad45e2#tags)Tags
...
### [](https://gist.github.com/JJediny/a466eed62cee30ad45e2#comments)Comments

Any content that you put between  `{% comment %}`  and  `{% endcomment %}`  tags is turned into a comment.

We made 1 million dollars {% comment %} in losses {% endcomment %} this year

### [](https://gist.github.com/JJediny/a466eed62cee30ad45e2#raw)Raw
...
### [](https://gist.github.com/JJediny/a466eed62cee30ad45e2#if--else)If / Else
...
### [](https://gist.github.com/JJediny/a466eed62cee30ad45e2#case-statement)Case Statement
...
### [](https://gist.github.com/JJediny/a466eed62cee30ad45e2#cycle)Cycle
...
### [](https://gist.github.com/JJediny/a466eed62cee30ad45e2#for-loops)For loops
...
### [](https://gist.github.com/JJediny/a466eed62cee30ad45e2#variable-assignment)Variable Assignment
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTE0MDE5MDM5OCwtNzI5MzI4MzEzXX0=
-->