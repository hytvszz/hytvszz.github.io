...
## 3.打开休眠模式
用管理员打开cmd，输入powercfg -a，你应该就可以看到你当前支持的睡眠模式。经过我的调查，现在大部分的新笔记本，都已经不支持了传统的S1-S3等级睡眠（逐步加深），而只支持一个最新的S0，这个S0状态下基本是
依稀记得S3很省电，基本等同于休眠。
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTExMjEzNjEwOTAsMTYyMjg5MTA1NCwtND
